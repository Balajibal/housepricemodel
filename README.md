...
<html lang="en">
  ...
  <body>    
        <div class="jumbotron jumbotron-fluid" style="background-color:magenta;">        
...
<html lang="en">
  ...
  <body>
        ...
        <div class="jumbotron jumbotron-fluid" style="background-color:chartreuse; ">
